  ...
  : Node("tribot_fake_node")
{
    ...
    "cmd_vel", qos, std::bind(&TribotFake::command_velocity_callback, this, std::placeholders::_1));

    update_timer_ = this->create_wall_timer(10ms, std::bind(&TribotFake::update_callback, this));
}
...
void TribotFake::command_velocity_callback(const geometry_msgs::msg::Twist::SharedPtr cmd_vel_msg)
{
    last_cmd_vel_time_ = this->now();
...
void TribotFake::update_callback()
{
...
bool TribotFake::update_odometry(const rclcpp::Duration & duration)
{
...
void TribotFake::update_joint_state()
{
...
void TribotFake::update_tf(geometry_msgs::msg::TransformStamped & odom_tf)
{
...
int main(int argc, char **argv)
{
    ...
    rclcpp::spin(std::make_shared<TribotFake>());
    rclcpp::shutdown();
